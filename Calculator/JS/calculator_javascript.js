...
function Handle_Operator(Next_Operator) {
    ...
    //When an operator key is pressed, we convert the current number displayed onto the screen to a number
...
//This function updates the calculator screen with conents of Display_Value
