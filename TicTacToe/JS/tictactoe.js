...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            select.style.backgroundImage = 'url("images/new_x_resize.png")';
            //Active playermay only be 'X' or 'O', the o.png is placed in HTML
        } else {
            // If activePlayer is equal to 'O', the o.png is placed in HTML
            select.style.backgroundImage = 'url("images/new_o_resize.png")';
        }
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    audio('./media/spin_swish.mp3');
    //This line calls our main animation loop
    animateLineDrawing();
    //This line waits 1 second, then clears canvas, resets game, and allows clikcing again
...
function resetGame() {
    ...
    //This resets our array so that it is empty and we can start over
    selectedSquares = [];
}