...
function get_todos() {
    /* This creates an array of trasks taht are inputed */
    var todos = new Array;
    /* this pulls the task that was saved in the web browser memory */
    var todos_str = localStorage.getItem('todo');
    /* if the input is not null then JSON.parse will 
    communicate with the web browser to make the taska JavaScript object */
    if (todos_str !== null) {
...
function show() {
    ...
    var html = '<ul>';
    /*this displays the task to the list in the order that it is inputed */
